...
<body>
    <div class="container">
        ...
        <div class="content" style="padding: 40px 30px; background: #ffffff;">
            <p style="margin: 0 0 15px 0; color: #1e293b; font-size: 16px;">Hi there,</p>

            <p style="margin: 0 0 15px 0; color: #1e293b; font-size: 16px;">I was researching law firms in <strong>${business.city}</strong> and came across <strong>${business.name}</strong>.</p>

            <p style="margin: 0 0 20px 0; color: #1e293b; font-size: 16px;">I noticed you could benefit from a stronger online presence to attract more clients in Orange County, so I went ahead and built you a professional website demo.</p>

            <div class="insight-box" style="background: #fef3c7; border-left: 4px solid #b45309; padding: 20px; margin: 25px 0; border-radius: 4px;">
                <strong style="color: #1e293b;">💡 Industry Insight:</strong> <span style="color: #1e293b;">73% of people looking for legal services start their search online. A professional website helps you capture those leads before they find your competitors.</span>
            </div>

            <div style="text-align: center; margin: 30px 0;">
                <a href="${demoUrl}" class="cta-button" style="display: inline-block; padding: 16px 40px; background: linear-gradient(135deg, #1e40af 0%, #0284c7 100%); color: white !important; text-decoration: none; border-radius: 8px; font-weight: bold; font-size: 18px;">
                    ⚖️ View Your Website Demo
                </a>
            </div>

            <p style="margin: 20px 0; color: #1e293b; font-size: 16px;"><strong>This isn't a template</strong> - it's custom-built specifically for ${business.name} by our AI:</p>

            <div class="features" style="background: #f8fafc; padding: 30px; border-radius: 12px; margin: 30px 0;">
                <h3 style="margin-top: 0; color: #1e40af; font-size: 20px;">What's included in your demo:</h3>
                <p style="margin: 5px 0; color: #1e293b; font-size: 15px; line-height: 1.8;">✓ Professional copywriting highlighting your 25+ years of experience<br>
            ...
            <h3 style="color: #1e40af; margin: 30px 0 15px 0; font-size: 20px;">Why law firms choose us:</h3>
            <ul style="line-height: 1.8; color: #1e293b; font-size: 15px; padding-left: 25px;">
                <li style="margin-bottom: 8px;"><strong>Fast deployment</strong> - Live in 24-48 hours, not 6 weeks</li>
                <li style="margin-bottom: 8px;"><strong>No huge upfront cost</strong> - $197/month vs $8,000-15,000 traditional</li>
                <li style="margin-bottom: 8px;"><strong>Unlimited changes</strong> - Need to update your practice areas? Just reply to this email</li>
                <li style="margin-bottom: 8px;"><strong>SEO optimized</strong> - Rank for local searches in Orange County</li>
                <li style="margin-bottom: 8px;"><strong>No technical skills needed</strong> - We handle everything</li>
            </ul>

            <div class="price" style="background: #f0fdf4; border: 2px solid #10b981; border-radius: 12px; padding: 20px; text-align: center; margin: 30px 0;">
                <div style="color: #64748b; margin-bottom: 5px; font-size: 14px;">Professional Website</div>
                <div style="font-size: 36px; font-weight: bold; color: #059669;">$197<span style="font-size: 18px; color: #64748b; font-weight: normal;">/month</span></div>
                <div style="color: #64748b; margin-top: 5px; font-size: 14px;">No contract • Cancel anytime</div>
            </div>

            <p style="text-align: center; margin: 20px 0;">
                <a href="https://buy.stripe.com/eVq5kFdx937Z6B4g9D7Re00" class="cta-button" style="display: inline-block; padding: 16px 40px; background: linear-gradient(135deg, #1e40af 0%, #0284c7 100%); color: white !important; text-decoration: none; border-radius: 8px; font-weight: bold; font-size: 18px;">
            ...
            <div style="margin: 50px 0 30px 0;">
                <p style="margin: 0 0 10px 0; color: #1e293b; font-size: 16px;"><strong>Compare the cost:</strong></p>
                <ul style="color: #64748b; line-height: 1.8; font-size: 15px; padding-left: 25px; margin: 10px 0 20px 0;">
                    <li style="margin-bottom: 8px;">Traditional web design: $8,000-15,000 upfront + $150/month maintenance</li>
                    <li style="margin-bottom: 8px;"><strong style="color: #1e293b;">OatCode: $197/month total</strong> (everything included, no setup fee)</li>
                </ul>

                <p style="margin: 20px 0 0 0; color: #1e293b; font-size: 16px;"><strong>Questions?</strong> Just reply to this email - I read every response personally.</p>
            </div>

            <p style="margin: 30px 0 10px 0; color: #1e293b; font-size: 16px; line-height: 1.6;">
                Best,<br>
            ...
            <p style="font-size: 12px; color: #94a3b8; margin-top: 30px; line-height: 1.5;">
        ...
        <div class="footer" style="background: #f8fafc; padding: 30px; text-align: center; color: #64748b; font-size: 14px;">
            <p style="margin: 0 0 15px 0; color: #1e293b;"><strong>Trusted by law firms across California</strong></p>
            <p style="margin: 0 0 20px 0; color: #64748b; line-height: 1.6;">We use AI to build professional websites instantly, so you can focus on practicing law while we handle your online presence.</p>
            <p style="margin-top: 20px;">
                <a href="${demoUrl}" style="color: #1e40af; text-decoration: none; font-weight: 600;">View Demo</a> <span style="color: #94a3b8;">•</span>
                <a href="https://buy.stripe.com/eVq5kFdx937Z6B4g9D7Re00" style="color: #1e40af; text-decoration: none; font-weight: 600;">Get Started</a>
            </p>
        </div>
    </div>
</body>
